...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      {/* ── Top utility bar ───────────────────────────────────────────── */}
      <div style={{ backgroundColor: '#0A1F12' }} className="py-2">
        <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <a
              href="tel:+919344912004"
              className="flex items-center gap-1.5 text-[#7aab8a] hover:text-white text-xs transition-colors"
            >
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 text-[#7aab8a] hover:text-white text-xs transition-colors"
            >
          ...
          <div className="flex items-center gap-5">
            ...
            <Link
              to="/login"
              className="flex items-center gap-1.5 text-[#5cc98a] hover:text-white text-xs font-medium transition-colors"
            >
              Login
            </Link>
          </div>
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between gap-8">
          ...
          <Link to="/home" className="flex items-center gap-2.5 shrink-0">
            <div className="w-8 h-8 bg-[#1a6e38] rounded-lg flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                ...
                <circle cx="8" cy="7.5" r="2" fill="#0A1F12"/>
              </svg>
            </div>
            <div>
          ...
          <div className="hidden md:flex items-center gap-2 shrink-0">
            ...
            <Link
              to="/contact"
              className="text-sm font-medium text-white bg-[#1a6e38] hover:bg-[#145530] px-4 py-1.5 rounded-md transition-colors"
            >
              Book a Demo
            </Link>
          </div>
          ...
          <div className="fixed inset-y-0 right-0 w-72 bg-white z-50 shadow-xl flex flex-col md:hidden">
            ...
            <div className="px-4 mt-auto pb-8 flex flex-col gap-3 border-t border-gray-100 pt-4">
              ...
              <Link
                to="/contact"
                onClick={() => setOpen(false)}
                className="text-sm font-medium text-center text-white bg-[#1a6e38] hover:bg-[#145530] px-4 py-2.5 rounded-lg transition-colors"
              >
                Book a Demo
              </Link>
            </div>
