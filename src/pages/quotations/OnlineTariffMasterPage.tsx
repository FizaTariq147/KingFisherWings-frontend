...
import { ChevronLeft, Plus, Search, ChevronDown, Maximize2, Heart } from 'lucide-react';
    ...
    <div>
      <div className="bg-white border border-gray-200 rounded-md">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200">
          <h2 className="text-[17px] font-medium text-gray-800">Online Tariff Master List</h2>
        ...
        {/* Search toolbar — no filter grid on this page */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200">
          <div className="flex items-center gap-2">
