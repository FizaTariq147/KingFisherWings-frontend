...
const mockNotifications: Notification[] = [
  ...
  { id: '7',  type: 'wms',       priority: 'medium', title: 'Low Stock Alert',                description: '8 SKUs are below minimum threshold at DXB Main Warehouse.',                          time: '5 hrs ago',   read: true,  actionLabel: 'View WMS',       actionPath: '/wms',                 meta: '8 items' },
  ...
  { id: '14', type: 'wms',       priority: 'low',    title: 'GRN Completed',                  description: 'GRN/2026/00089 — 480 units received at DXB Main Warehouse for DP World.',          time: '3 days ago',  read: true,  actionLabel: 'View GRN',       actionPath: '/wms',                 meta: '480 units' },
