...
export default function SalesMenuPage() {
  ...
  const ReportsIcon = reportsSalesTile.icon as ComponentType<{ size: number }>;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="p-6 grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        {/* Reports - Sales: centered icon layout */}
        <button
          onClick={() => navigate(reportsSalesTile.path)}
        ...
        >
          ...
          <h3 className="text-[15px] text-[#0A2942] font-normal mb-3">
            {reportsSalesTile.title}
          </h3>
          <p className="text-sm text-gray-500 leading-relaxed">
            {reportsSalesTile.description}
          </p>
        </button>
      </div>
    </div>
