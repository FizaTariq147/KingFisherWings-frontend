    ...
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          ...
          className="absolute right-0 top-full z-50 mt-2 w-[min(100vw-1.5rem,24rem)] overflow-hidden rounded-lg border border-[var(--color-neutral-200)] bg-white text-[var(--color-neutral-800)] shadow-lg"
        >
          <div className="border-b border-[var(--color-neutral-100)] p-2">
            <div className="flex items-center gap-2 rounded-md border border-[var(--color-neutral-200)] bg-white px-2">
              ...
              {loading ? (
                <Loader2
                  size={16}
                  className="shrink-0 animate-spin text-[var(--color-primary-500)]"
                />
              ) : null}
              {query ? (
                <button
