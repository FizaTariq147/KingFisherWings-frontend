    ...
    <div className="relative">
      ...
      <Table className="min-w-[720px]">
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              {TENANT_TABLE_COLUMNS.map((col) => {
                const sortKey = isSortableColumn(col.key) ? col.key : null;
                return (
          ...
          <TableBody>
            ...
            {tenants.map((t) => (
              <TableRow key={t.id}>
                <TableCell mono>{t.code}</TableCell>
                <TableCell>
                  <button
                    type="button"
                ...
                <TableCell className="hidden sm:table-cell">{t.max_users}</TableCell>
                <TableCell className="hidden lg:table-cell text-xs text-[var(--color-neutral-500)]">
