    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-[var(--color-neutral-500)]">
          Tenant-wide list of customer portal logins. Invite and manage users from any party detail
          page under Users Portal.
        </p>
      </div>
      ...
      <Card className="p-0 overflow-hidden">
        {isLoading ? (
          <p className="p-6 text-sm text-[var(--color-neutral-400)]">Loading portal users…</p>
        ) : isError ? (
          ...
          <p className="p-6 text-sm text-[var(--color-neutral-400)]">
            No customer portal users found. Open a party and use the Users Portal tab to create a
            login.
          </p>
        ) : (
