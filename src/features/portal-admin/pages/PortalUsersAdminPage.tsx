...
import { useTenantPortalUsers } from '../hooks/usePortalAdmin';
...
export default function PortalUsersAdminPage() {
  ...
  const { data = [], isLoading, isError, error, refetch, isFetching } = useTenantPortalUsers(
    filterPartyId ? { party_id: filterPartyId } : {},
  );
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="overflow-hidden rounded-xl border border-[#0A2942]/10 bg-[#0A2942] px-5 py-5 sm:px-6">
        <div className="flex flex-wrap items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xl font-semibold text-white">Customer Portal users</h1>
            <p className="mt-1 max-w-2xl text-sm text-white/65">
              Tenant-wide list of customer portal logins. Invite and manage users from any party
              detail page under Users Portal.
            </p>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
          ...
          <div className="min-w-0 flex-1">
            <Input
              ...
              placeholder="Leave blank for all portal users"
            />
          </div>
        </div>
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        {isLoading ? (
          <p className="p-8 text-center text-sm text-gray-400">Loading portal users…</p>
        ) : isError ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 px-6 py-14 text-center">
            ...
            <p className="text-sm font-medium text-gray-700">No customer portal users found.</p>
            <p className="max-w-md text-xs text-gray-400">
              Open a party and use the Users Portal tab to create a login.
            </p>
          </div>
